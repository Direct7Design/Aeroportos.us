<?php
	...
	function titulo($origem)
	{
		if(!empty($origem)) {
			return '<title>Aeroportos.us - Dist&acirc;ncia entre '.$origem.' e '.$destino.'</title>';
		} else {
			return '<title>Aeroportos.us - Dist&acirc;ncia entre aeroportos</title>';
		}
	}
?>